					...
					<div class="pull-right">
						<ul class="nav navbar-nav navbar-right">
							<li id="cntonline" class="hidden-xs usonline">
								...
								<li class="vis register" data-toggle="modal" href="registro" >  <!-- #modal-register -->
										<a  role="button" href="registro">			
		...
		<div class="modal fade" id="modal-register">
			<div class="modal-dialog login">
				<div class="modal-content">
					...
					<iframe width="278" height="510" src="xc_reg" scrolling="no" frameborder="0" allowfullscreen></iframe>
