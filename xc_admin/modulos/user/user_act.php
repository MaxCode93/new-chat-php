...
if(isset($_POST['Submit']))
{
    ...
    <?php
        ...
        $count = 0;
        $sql = "Update users set estatus=1 ";
        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Activar Usuarios</h4>
                </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
              <li><a href="escritorio">Escritorio</a></li>
                        <li class="active">Activar Usuarios</li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="col-sm-12">
                    <div class="white-box">
                        <form action="" method="post" name="f1" id="f1">
                            <h3 class="box-title">Activar Usuarios</h3>
                            <hr>
                            <div class="panel-body" style="width:70%; margin-left:15%">
                                ...
                                <div class="form-group" align="center">
                                    <div class="col-sm-8 col-sm-offset-2">
                                        ...
                                        <input name="Submit" type="submit" class="btn btn-danger" value="Si, Activarlo(s)!">
