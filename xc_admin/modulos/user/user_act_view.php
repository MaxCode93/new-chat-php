...
$query_z = "Update admins set zona='Viendo los Usurios No Activados' WHERE user_nick = '".$_SESSION['admin']['username']."' LIMIT 1";
...
?>
    ...
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Usurios No Activados</h4>
        </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="escritorio">Escritorio</a></li>
                <li class="active">Usurios No Activados</li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <form action="act" method="post" name="f1" id="f1">
                    <div>
                        <div class="pull-left"><h3 class="box-title">Lista de los Usurios No Activados</h3></div>
                        <div class="pull-right">
                            <p class="text-muted">
                                <button type="submit" name="submit" class="btn btn-danger waves-effect waves-light m-r-10"><i class="fa fa-trash-o"></i> Activar Seleccionados</button>
                            </p>
                        </div>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="myTable" class="table table-striped">
                            ...
                            <tbody>
                            <?php
                            $query = "SELECT * FROM users where estatus=0 ORDER BY user_nick DESC";
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap">
									 <a href="act?id=<?php echo $id;?>" data-toggle="tooltip" data-original-title="Activar usuario <?php echo $username ?>"> <i class="fa fa-edit btn btn-success waves-effect waves-light m-r-10"></i> </a>
                                     <a href="users_delete?id=<?php echo $id;?>" data-toggle="tooltip" data-original-title="Eliminar usuario <?php echo $username ?>"> <i class="fa fa-trash-o btn btn-danger waves-effect waves-light m-r-10"></i></a>
                                    </td>
                                </tr>
                            <?php }?>
